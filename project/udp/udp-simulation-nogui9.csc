...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype242</identifier>
    ...
    <mote>
      ...
      <motetype_identifier>mtype242</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>62.40674243893868</x>
        <y>14.841155259692322</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>44.59694208985459</x>
        <y>76.89637187120992</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>29.354713940288605</x>
        <y>30.426116498734856</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>106.30648143776854</x>
        <y>65.32155563418215</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>116.8548721185598</x>
        <y>18.191985440837357</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>21.535018487137513</x>
        <y>116.39988114241106</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>-0.7666029126917451</x>
        <y>63.03187030655161</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
...
while(true) {
    ...
    if (msg.contains(completeMsg)) {
        completed[id] = true;
        if (Object.keys(completed).length &gt;= motesCount) {
            break;
        }
    } else if (firstScheduleMsgTime == 0) {
        if (msg.contains(scheduleMsg)) {
            firstScheduleMsgTime =  time;
        }
    }
    YIELD();
}
log.log("First schedule message received at time: " + firstScheduleMsgTime + "\n");
var endTime = time;
log.log("Simulation finished at time: " + time + "\n");
log.log("Number of secondes to install the new schedule: " + ((endTime - firstScheduleMsgTime) / 1000 / 1000 / speedLimit) + "\n");
