...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype367</identifier>
    ...
    <motetype>
      ...
      <commands>make client.cooja TARGET=cooja -j8</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      <interface_config>
        ...
        <x>14.028825046191562</x>
        <y>88.38764951052033</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype367</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>36.90584077140099</x>
        <y>88.19218931600837</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.1391702671566093 0.0 0.0 1.1391702671566093 197.71826406046588 123.20242472888403</viewport>
    </plugin_config>
    <width>400</width>
    <z>2</z>
    <height>400</height>
